...
class DatePickerDialog: UIView {
    ...
    fileprivate let kDateButtonSpacerHeight:                    CGFloat = 1
    ...
    @objc func deviceOrientationDidChange(_ notification: Foundation.Notification) {
        self.frame = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.size.height)
        let screenSize = countScreenSize()
        let dialogSize = CGSize(width: 300, height: 230 + kDatePickerDialogDefaultButtonHeight + kDateButtonSpacerHeight)
    ...
    func show(_ title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: Date = Date(),
              minimumDate: Date? = nil, maximumDate: Date? = nil, datePickerMode: UIDatePickerMode = .dateAndTime,
    ...
    fileprivate func createContainerView() -> UIView {
        ...
        let dialogContainerY = dialogContainer.bounds.size.height - kDatePickerDialogDefaultButtonHeight - kDateButtonSpacerHeight
        let dialogContainerWidth = dialogContainer.bounds.size.width
        let dialogContainerHeight = kDateButtonSpacerHeight
        let lineView = UIView(frame: CGRect(x: 0, y: dialogContainerY, width: dialogContainerWidth, height: dialogContainerHeight))
